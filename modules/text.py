class Text:
    def __init__(self, player, enemy, potential_damage=0, potential_health=0, time=None):
        ...
        self.attack = f"Du attackerar {enemy.name} med {player.inventory["weapon"].name} och gör {player.inventory["weapon"].attack} skada!"
        ...
        self.found_weapon = f"Du hittade ett nytt vapen i lådan och bytte ut ditt gamla mot {enemy.inventory["weapon"].name}."
